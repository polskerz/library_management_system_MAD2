...
export default {
    ...
    methods: {
        async loadUserData() {
            try {   
                const response = await fetch(`/user/profile/${this.$route.params.user_id}`,{
                    headers: {
        ...
        async editUser() {
            try {    
                const response = await fetch(`/user/edit_user/${this.$route.params.user_id}`, {
                    method: 'PUT',  
                    headers: {
                ...
                if (response.ok) {
                    ...
                    alert(`Error editing user: ${errorData.message}`);
                }
            } catch (error) {
